...
*/
    silentBigInteger.prototype.isUnit = function() {
...
*/
    silentBigInteger.prototype.multiply = function(n) {
      ...
      return new silentBigInteger(partial, this._s * n._s, CONSTRUCT);
    };

    // Multiply a silentBigInteger by a single-digit native number
    // Assumes that this and n are >= 0
    // This is not really intended to be used outside the library itself
    silentBigInteger.prototype.multiplySingleDigit = function(n) {
      if (n === 0 || this._s === 0) {
        return ZERO;
      }
      if (n === 1) {
      ...
      if (this._d.length === 1) {
        ...
        if (digit >= BigInteger_base) {
          return new silentBigInteger([(digit % BigInteger_base) | 0, (digit / BigInteger_base) | 0], 1, CONSTRUCT);
        }
        return new silentBigInteger([digit], 1, CONSTRUCT);
      }
      ...
      if (this.isUnit()) {
        return new silentBigInteger([n], 1, CONSTRUCT);
      }
      ...
      return new silentBigInteger(partial, 1, CONSTRUCT);
    };

/*
        Function: square
        Multiply a <silentBigInteger> by itself.
        ...
        See Also:
                <multiply>
*/
    silentBigInteger.prototype.square = function() {
      ...
      return new silentBigInteger(imult1, 1, CONSTRUCT);
    };
...
/*
        ...
        Parameters:
                ...
                n - The number to divide *this* by. Will be converted to a <silentBigInteger>.
...
*/
    silentBigInteger.prototype.quotient = function(n) {
...
*/
    silentBigInteger.prototype.divide = silentBigInteger.prototype.quotient;
...
/*
        ...
        Parameters:
                ...
                n - The remainder after *this* is divided *this* by *n*. Will be
                    converted to a <silentBigInteger>.
        ...
        See Also:
                ...
                <divRem>, <quotient>
*/
    silentBigInteger.prototype.remainder = function(n) {
...
/*
        ...
        See Also:
                ...
                <quotient>, <remainder>
*/
    silentBigInteger.prototype.divRem = function(n) {
      n = silentBigInteger(n);
      if (n._s === 0) {
      ...
      var part = new silentBigInteger([], 0, CONSTRUCT);
      part._s = 1;
      ...
      return [new silentBigInteger(quot.reverse(), sign, CONSTRUCT), new silentBigInteger(part._d, this._s, CONSTRUCT)];
    };

    // Throws an exception if n is outside of (-silentBigInteger.base, -1] or
    // [1, silentBigInteger.base).  It's not necessary to call this, since the
    // other division functions will call it if they are able to.
    silentBigInteger.prototype.divRemSmall = function(n) {
      var r;
      n = +n;
      if (n === 0) {
        throw new Error("Divide by zero");
      ...
      if (n === 1 || n === -1) {
        return [(sign === 1) ? this.abs() : new silentBigInteger(this._d, sign, CONSTRUCT), ZERO];
      }

      // 2 <= n < BigInteger_base
      // divide a single digit by a single digit
      if (this._d.length === 1) {
        var q = new silentBigInteger([(this._d[0] / n) | 0], 1, CONSTRUCT);
        r = new silentBigInteger([(this._d[0] % n) | 0], 1, CONSTRUCT);
        if (sign < 0) {
          q = q.negate();
        }
        if (this._s < 0) {
      ...
      r = new silentBigInteger([diff], 1, CONSTRUCT);
      if (this._s < 0) {
        r = r.negate();
      }
      return [new silentBigInteger(quot.reverse(), sign, CONSTRUCT), r];
    };
...
/*
        ...
        Note that <silentBigInteger.ZERO> is even.
        ...
        See Also:
                ...
                <isOdd>
*/
    silentBigInteger.prototype.isEven = function() {
      var digits = this._d;
...
/*
        ...
        See Also:
                ...
                <isEven>
*/
    silentBigInteger.prototype.isOdd = function() {
      return !this.isEven();
    };

/*
        Function: sign
        Get the sign of a <silentBigInteger>.
        ...
        See Also:
                ...
                <isZero>, <isPositive>, <isNegative>, <compare>, <silentBigInteger.ZERO>
*/
    silentBigInteger.prototype.sign = function() {
      return this._s;
    };
...
/*
        ...
        Returns:
                ...
                true if *this*.compare(<silentBigInteger.ZERO>) == 1.

        See Also:

                <sign>, <isZero>, <isNegative>, <isUnit>, <compare>, <silentBigInteger.ZERO>
*/
    silentBigInteger.prototype.isPositive = function() {
      return this._s > 0;
    };
...
/*
        ...
        See Also:
                ...
                <sign>, <isPositive>, <isZero>, <isUnit>, <compare>, <silentBigInteger.ZERO>
*/
    silentBigInteger.prototype.isNegative = function() {
      return this._s < 0;
    };
...
/*
        ...
        Returns:
                ...
                true if *this*.compare(<silentBigInteger.ZERO>) == 0.

        See Also:

                <sign>, <isPositive>, <isNegative>, <isUnit>, <silentBigInteger.ZERO>
*/
    silentBigInteger.prototype.isZero = function() {
      return this._s === 0;
    };

/*
        Function: exp10
        Multiply a <silentBigInteger> by a power of 10.

        This is equivalent to, but faster than

        > if (n >= 0) {
        >     return this.multiply(silentBigInteger("1e" + n));
        > }
        > else { // n <= 0
        >     return this.quotient(silentBigInteger("1e" + -n));
        > }

        Parameters:

                n - The power of 10 to multiply *this* by. *n* is converted to a
                javascipt number and must be no greater than <silentBigInteger.MAX_EXP>
        ...
        See Also:
                ...
                <pow>, <multiply>
*/
    silentBigInteger.prototype.exp10 = function(n) {
      n = +n;
      if (n === 0) {
        return this;
      }
      if (Math.abs(n) > Number(MAX_EXP)) {
        throw new Error("exponent too large in silentBigInteger.exp10");
      }
      if (n > 0) {
        var k = new silentBigInteger(this._d.slice(), this._s, CONSTRUCT);
...
/*
        Function: pow
        Raise a <silentBigInteger> to a power.
        ...
        Parameters:
                ...
                <silentBigInteger.MAX_EXP> (0x7FFFFFFF), or an exception will be thrown.
        ...
        See Also:
                ...
                <modPow>
*/
    silentBigInteger.prototype.pow = function(n) {
      if (this.isUnit()) {
        if (this._s > 0) {
          return this;
        } else {
          return silentBigInteger(n).isOdd() ? this : this.negate();
        }
      }
      ...
      if (n.compareAbs(MAX_EXP) > 0) {
        throw new Error("exponent too large in silentBigInteger.pow");
      }
      var x = this;
      var aux = ONE;
      var two = silentBigInteger.small[2];
...
/*
        Function: modPow
        Raise a <silentBigInteger> to a power (mod m).

        Because it is reduced by a modulus, <modPow> is not limited by
        <silentBigInteger.MAX_EXP> like <pow>.
        ...
        See Also:
                ...
                <pow>, <mod>
*/
    silentBigInteger.prototype.modPow = function(exponent, modulus) {
      var result = ONE;
      var base = this;
      ...
      while (exponent.isPositive()) {
        ...
        exponent = exponent.quotient(silentBigInteger.small[2]);
...
/*
        Function: log
        Get the natural logarithm of a <silentBigInteger> as a native JavaScript number.
        ...
        See Also:
                ...
                <toJSValue>
*/
    silentBigInteger.prototype.log = function() {
      switch (this._s) {
      case 0:
        return -Infinity;
      case -1:
      ...
      return Math.log((new silentBigInteger(firstNdigits, 1, CONSTRUCT)).valueOf()) + (l - N) * Math.log(BigInteger_base);
    };

/*
        Function: valueOf
        Convert a <silentBigInteger> to a native JavaScript integer.

        This is called automatically by JavaScipt to convert a <silentBigInteger> to a
        native value.
        ...
        See Also:
                ...
                <toString>, <toJSValue>
*/
    silentBigInteger.prototype.valueOf = function() {
...
/*
        ...
        See Also:
                ...
                <toString>, <valueOf>
*/
    silentBigInteger.prototype.toJSValue = function() {
      return parseInt(this.toString(), 10);
    };

    var MAX_EXP = silentBigInteger(0x7FFFFFFF);
    // Constant: MAX_EXP
    // The largest exponent allowed in <pow> and <exp10> (0x7FFFFFFF or 2147483647).
    silentBigInteger.MAX_EXP = MAX_EXP;

    (function() {
      function makeUnary(fn) {
        return function(a) {
          return fn.call(silentBigInteger(a));
        };
      }

      function makeBinary(fn) {
        return function(a, b) {
          return fn.call(silentBigInteger(a), silentBigInteger(b));
        };
      }

      function makeTrinary(fn) {
        return function(a, b, c) {
          return fn.call(silentBigInteger(a), silentBigInteger(b), silentBigInteger(c));
        };
      }
      ...
      (function() {
        ...
        for (i = 0; i < unary.length; i++) {
          fn = unary[i];
          silentBigInteger[fn] = makeUnary(silentBigInteger.prototype[fn]);
        }

        for (i = 0; i < binary.length; i++) {
          fn = binary[i];
          silentBigInteger[fn] = makeBinary(silentBigInteger.prototype[fn]);
        }

        for (i = 0; i < trinary.length; i++) {
          fn = trinary[i];
          silentBigInteger[fn] = makeTrinary(silentBigInteger.prototype[fn]);
        }

        silentBigInteger.exp10 = function(x, n) {
          return silentBigInteger(x).exp10(n);
        };
      })();
    })();

    exports.silentBigInteger = silentBigInteger;
